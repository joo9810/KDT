...
def upload():
    ...
    loaded_vectorizer = joblib.load('/Users/anhyojun/WorkSpace/KDT2/김소현 강사님/프로젝트/7번째 프로젝트/WEBPAGE2/tfid_vectorizer.pkl')
    ...
    best_model.load_state_dict(torch.load('/Users/anhyojun/WorkSpace/KDT2/김소현 강사님/프로젝트/7번째 프로젝트/WEBPAGE2/Best_LSTM_Model.pth', weights_only=True))
